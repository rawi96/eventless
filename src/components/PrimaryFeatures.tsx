...
const features = [
  {
    ...
    description:
      'Easily create and publish events with our intuitive interface. Customize every detail to fit your exact needs, from event schedules to participant limits.',
    image: screenshotPayroll,
  },
  {
    title: 'Powerful API Access',
    description:
      'Seamlessly integrate your events with other platforms using our robust API. Access event details, participant information, and more, directly from your applications.',
    image: screenshotExpenses,
  },
  {
    title: 'User Registration Management',
    description:
      'Allow users to register for events effortlessly. Track and manage registrations in real-time, ensuring a smooth experience for both organizers and attendees.',
