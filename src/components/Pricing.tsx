...
function Plan({
  ...
  return (
    ...
    >
      ...
      <Button
        onClick={() => signIn('google', { callbackUrl: '/application/dashboard' })}
        color="white"
        className="mt-8"
        ...
        <div className="md:text-center">
          <h2 className="font-display text-3xl tracking-tight text-white sm:text-4xl">
            <span className="relative whitespace-nowrap">
              ...
              <span className="relative">Flexible pricing,</span>
            </span>{' '}
            for every event.
          </h2>
          <p className="mt-4 text-lg text-slate-400">
            No matter the scale of your event, Eventless has a plan that fits your needs.
          </p>
        </div>
        <div className="-mx-4 mt-16 grid max-w-2xl grid-cols-1 gap-y-10 sm:mx-auto lg:-mx-8 lg:max-w-none lg:grid-cols-3 xl:mx-0 xl:gap-x-8">
          <Plan
            ...
            features={[
              ...
              'Email support',
              'Access to analytics for 1 event',
            ]}
          />
          <Plan
            featured
            ...
            features={[
              ...
              'Access to analytics for 5 events',
