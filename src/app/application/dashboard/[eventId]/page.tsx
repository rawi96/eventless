        ...
        <div className="mt-6 border-t border-gray-100">
          <dl className="divide-y divide-gray-100">
            ...
            <div className="py-6 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0">
              ...
              <dd
                className={`mt-1 text-sm leading-6 ${isPastDate(event.eventDate) ? 'text-red-600' : 'text-gray-700'} sm:col-span-2 sm:mt-0`}
              >
            ...
            <div className="py-6 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0">
              ...
              <dd
                className={`mt-1 text-sm leading-6 ${isPastDate(event.registrationEndDate) ? 'text-red-600' : 'text-gray-700'} sm:col-span-2 sm:mt-0`}
              >
